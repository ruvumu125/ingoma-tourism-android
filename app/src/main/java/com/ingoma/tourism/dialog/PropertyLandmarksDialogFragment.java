...
public class PropertyLandmarksDialogFragment extends BottomSheetDialogFragment {
    ...
    public PropertyLandmarksDialogFragment(List<Landmark> landmarkList) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = root.findViewById(R.id.popular_landmark_rv);
        LandmarksAdapter adapter = new LandmarksAdapter(landmarkList);
